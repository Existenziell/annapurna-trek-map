...
/** Eye icon. Use for "show" / reveal balance. */
...
/** Eye with slash. Use for "hide" / mask balance. */
...
export function RefreshIcon({ className, ...props }: IconProps) {
  return (
    ...
    >
      <path
        d="M81.521 31.109c-.86-1.73-2.959-2.438-4.692-1.575-1.73.86-2.436 2.961-1.575 4.692 2.329 4.685 3.51 9.734 3.51 15.01C78.764 67.854 63.617 83 45 83S11.236 67.854 11.236 49.236c0-16.222 11.501-29.805 26.776-33.033l-3.129 4.739c-1.065 1.613-.62 3.784.992 4.85.594.392 1.264.579 1.926.579 1.136 0 2.251-.553 2.924-1.571l7.176-10.87.002-.003.018-.027c.063-.096.106-.199.159-.299.049-.093.108-.181.149-.279a3.37 3.37 0 0 0 .197-.634c.009-.041.008-.085.015-.126.031-.182.053-.364.055-.547 0-.014.004-.028.004-.042 0-.066-.016-.128-.019-.193a4.34 4.34 0 0 0-.043-.431 3.41 3.41 0 0 0-.071-.283 4.24 4.24 0 0 0-.109-.35 4.08 4.08 0 0 0-.125-.276 4.07 4.07 0 0 0-.17-.313 3.8 3.8 0 0 0-.175-.25 3.74 3.74 0 0 0-.223-.27 3.69 3.69 0 0 0-.234-.228c-.047-.042-.085-.092-.135-.132L36.679.775c-1.503-1.213-3.708-.977-4.921.53-1.213 1.505-.976 3.709.53 4.921l3.972 3.2C17.97 13.438 4.236 29.759 4.236 49.236 4.236 71.714 22.522 90 45 90s40.764-18.286 40.764-40.764c0-6.366-1.427-12.464-4.243-18.127Z"
        fill="currentColor"
      />
    </svg>
  )
